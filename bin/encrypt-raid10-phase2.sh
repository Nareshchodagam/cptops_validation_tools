...
MDH_TARGET_1_DISK=$(cat /etc/flux/.${HOME}_target_1_disk_plain)
...
echo "/dev/mapper/luks-${MDH_LUKS_UUID}        /${HOME}     xfs     defaults,dirsync,noatime,_netdev,x-systemd.automount       0 0" >> /etc/fstab
